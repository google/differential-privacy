...
#ifndef DIFFERENTIAL_PRIVACY_BASE_STATUSOR_INTERNALS_H_
#define DIFFERENTIAL_PRIVACY_BASE_STATUSOR_INTERNALS_H_
...
#endif  // DIFFERENTIAL_PRIVACY_BASE_STATUSOR_INTERNALS_H_
