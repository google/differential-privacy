...
const std::string folder_name = "BoundedMeanSamples";
...
double BoundedMeanAlgorithm(std::vector<double> values, double granularity,
  double epsilon, int max_partitions, int max_contributions, int lower, int upper) {
    std::unique_ptr<BoundedMean<double>> boundedmean =
        BoundedMean<double>::Builder().SetEpsilon(epsilon)
...
CreateSingleScenario(1,zero_vector,valuesB1,0.0078125,default_epsilon,1,1,0,1,num_of_samples,ratio);

// Laplace noise, empty mean, many partitions contributed
std::vector<double>valuesB2(1000,25);
CreateSingleScenario(2,zero_vector,valuesB2,0.25,default_epsilon,25,1,0,1,num_of_samples,ratio);

// Laplace noise, empty mean, many contributions per partition
std::vector<double>valuesB3(1000,10);
CreateSingleScenario(3,zero_vector,valuesB3,0.25,default_epsilon,1,10,0,1,num_of_samples,ratio);

// Laplace noise, empty mean, large bounds
std::vector<double>valuesB4{-50000};
CreateSingleScenario(4,zero_vector,valuesB4,0.25,default_epsilon,1,1,-50,50,num_of_samples,ratio);

// Laplace noise, empty mean, small epsilon
std::vector<double>valuesB5{1000};
CreateSingleScenario(5,zero_vector,valuesB5,0.0625,small_epsilon,1,1,0,1,num_of_samples,ratio);

// Laplace noise, empty mean, large epsilon
std::vector<double>valuesB6{1000};
CreateSingleScenario(6,zero_vector,valuesB6,0.03125,large_epsilon,1,1,0,1,num_of_samples,ratio);

// Laplace noise, small positive mean, default parameters
std::vector<double>valuesA7{1};
std::vector<double>valuesB7{1,-1000};
CreateSingleScenario(7,valuesA7,valuesB7,0.015625,default_epsilon,1,1,0,1,num_of_samples,ratio);

// Laplace noise, small positive mean, many partitions contributed
CreateSingleScenario(8,zero_vector,zero_vector,0.25,default_epsilon,25,1,0,1,num_of_samples,ratio,
    1,25,-1000);

// Laplace noise, small positive mean, many contributions per partition
CreateSingleScenario(9,zero_vector,zero_vector,0.25,default_epsilon,1,10,0,1,num_of_samples,ratio,
  1,10,-1000);

// Laplace noise, small positive mean, small epsilon
std::vector<double>valuesA10{1};
std::vector<double>valuesB10{1,-1000};
CreateSingleScenario(10,valuesA10,valuesB10,0.0625,small_epsilon,1,1,0,1,num_of_samples,ratio);

// Laplace noise, small positive mean, large epsilon
std::vector<double>valuesA11{1};
std::vector<double>valuesB11{1,-1000};
CreateSingleScenario(11,valuesA11,valuesB11,0.0625,large_epsilon,1,1,0,1,num_of_samples,ratio);
...
CreateSingleScenario(12,valuesA12,valuesB12,0.015625,default_epsilon,1,1,0,1,num_of_samples,ratio);

// Laplace noise, large positive mean, default parameters
std::vector<double>valuesA13{50};
std::vector<double>valuesB13{50,-1000};
CreateSingleScenario(13,valuesA13,valuesB13,0.25,default_epsilon,1,1,0,50,num_of_samples,ratio);

// Laplace noise, large positive mean, many partitions contributed 
CreateSingleScenario(14,zero_vector,zero_vector,2,default_epsilon,25,1,0,50,
  num_of_samples,ratio,50,25,-1000);

// Laplace noise, large positive mean, many contributions per partition
CreateSingleScenario(15,zero_vector,zero_vector,1,default_epsilon,1,10,0,50,
...
CreateSingleScenario(16,valuesA16,valuesB16,2,small_epsilon,1,1,0,50,num_of_samples,ratio);

// Laplace noise, large positive mean, large epsilon
std::vector<double>valuesA17{50};
std::vector<double>valuesB17{50,-1000};
CreateSingleScenario(17,valuesA17,valuesB17,0.5,large_epsilon,1,1,0,50,num_of_samples,ratio);
...
CreateSingleScenario(18,valuesA18,valuesB18,0.25,default_epsilon,1,1,0,50,num_of_samples,ratio);

// Laplace noise, large mixed mean, default parameters
std::vector<double>valuesA19{-50};
std::vector<double>valuesB19{-50,50000};
CreateSingleScenario(19,valuesA19,valuesB19,0.5,default_epsilon,1,1,-50,50,num_of_samples,ratio);

// Laplace noise, large mixed mean, many partitions contributed
CreateSingleScenario(20,zero_vector,zero_vector,2,default_epsilon,25,1,-50,50,
  num_of_samples,ratio,-50,25,50000);

// Laplace noise, large mixed mean, many contributions per partition
CreateSingleScenario(21,zero_vector,zero_vector,2,default_epsilon,1,10,-50,50,
...
CreateSingleScenario(22,valuesA22,valuesB22,0.5,default_epsilon,1,1,-50,50,num_of_samples,ratio);
    }
  }
}
