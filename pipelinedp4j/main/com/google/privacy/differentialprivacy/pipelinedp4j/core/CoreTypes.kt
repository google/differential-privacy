 ...
 * type and value of List<PerFeatureValues> type.
 */
...
/** Helper function to get the privacy ID of the given [MultiFeatureContribution]. */
fun <PrivacyIdT : Any, PartitionKeyT : Any> MultiFeatureContribution<PrivacyIdT, PartitionKeyT>
  .privacyId() = first.first

/** Helper function to get the partition key of the given [MultiFeatureContribution]. */
fun <PrivacyIdT : Any, PartitionKeyT : Any> MultiFeatureContribution<PrivacyIdT, PartitionKeyT>
