  ...
  fun from_withScalarValueExtractor_constructsDataExtractors() {
    ...
    val dataExtractors =
      DataExtractors.from(
        ...
        ef.strings(),
        valueExtractors =
          listOf(FeatureValueExtractor("feature") { inputRow: InputRow -> listOf(inputRow.value) }),
      )
  ...
  fun from_withVectorValueExtractor_constructsDataExtractors() {
    ...
    val dataExtractors =
      DataExtractors.from(
        ...
        valueExtractors =
          listOf(
            FeatureValueExtractor("feature") { inputRow: InputRow ->
  ...
  fun from_withMultipleFeatures_constructsDataExtractors() {
    ...
    val dataExtractors =
      DataExtractors.from(
        ...
        valueExtractors =
          listOf(
            FeatureValueExtractor("feature1") { inputRow: InputRow -> listOf(inputRow.value) },
            FeatureValueExtractor("feature2") { inputRow: InputRow ->
