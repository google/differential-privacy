...
func (laplace) ConfidenceIntervalInt64(noisedX, l0Sensitivity, lInfSensitivity int64, epsilon, delta, confidenceLevel float64) (ConfidenceInterval, error) {
	// TODO: Implement confidence interval computation.
	return ConfidenceInterval{}, nil
}

func (laplace) ConfidenceIntervalFloat64(noisedX float64, l0Sensitivity int64, lInfSensitivity, epsilon, delta, confidenceLevel float64) (ConfidenceInterval, error) {
	// TODO: Implement confidence interval computation.
	return ConfidenceInterval{}, nil
}
