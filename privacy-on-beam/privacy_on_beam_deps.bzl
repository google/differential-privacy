...
def privacy_on_beam_deps():
    ...
    go_repository(
        ...
        sum = "h1:6U90JC2I5nGujFftlzeNVQj0Of2fFsh0XGoEoIIxxpE=",
        version = "v2.54.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:QOC2K4A42RQpcrZyptP6z9EJZnlHfHJUfZrAAHe15q4=",
        version = "v1.7.7",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:XITZTrq+52tZyZxUOtFIahUf3aH367FLxJzt9vZeAF8=",
    ...
    go_repository(
        ...
        sum = "h1:hJ3s7GbWlGK4YVV92sO88BQSyF4ZLVy7/awqOlPxFbA=",
        version = "v0.11.1",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:f5VDy+GMu7JyuFA0Fef+6TfulfCs5nBTgq7MMkFJx5Y=",
        version = "v2.10.7",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:BJ+qhUEiF8RQj37lAyzmyZyGVaJ7ljU2hSpLJl/EU9U=",
        version = "v1.62.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:5kmxD5VNzRhCCxZF+o8ioT+Czcs9jpE7JcuYCIRg2x0=",
        version = "v1.8.1",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:H1/4SqSUhjPFE7L5ddzHOfY2bCAvjwNRZPNl6Ni5oYU=",
        version = "v1.25.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:anj3irEyL5kylWipe810j0S/lgHret3Y4F3CZ8QxAGo=",
        version = "v1.32.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:nAUD4aiWHZFYyINhRag1qOnHUk0/7QiWEa04XWnqACA=",
        version = "v1.36.2",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:qRDc5Zmhlb3Vh5s8/tfPGsUCutYtlmQ0sPHaoSja00w=",
        version = "v2.10.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:kR1pGDmTK1AXmitgDIEPvGWjY7aJCopZmkxq0yDxNpc=",
        version = "v1.26.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:MBRe+Ki4mMN93jhDDbpuRLjRddooArz4FeSObvUMmjY=",
        version = "v0.168.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:Fe8QycXyEd9mJgnwB9kmw00WgB43eQ/xYO5C6gceybQ=",
