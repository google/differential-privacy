...
def privacy_on_beam_deps():
    ...
    go_repository(
        ...
        sum = "h1:niIy5jl5sgRq4XkCSSwXsqsiss5eW05snpKmabWIfJI=",
        version = "v2.52.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:CpTS3XO3MWNel8ohoazkLZC6scvkYL2k+m0yzFJ17Hg=",
        version = "v1.22.0",
    )
    go_repository(
        name = "com_github_aws_aws_sdk_go_v2_aws_protocol_eventstream",
        importpath = "github.com/aws/aws-sdk-go-v2/aws/protocol/eventstream",
        sum = "h1:Sc82v7tDQ/vdU1WtuSyzZ1I7y/68j//HJ6uozND1IDs=",
        version = "v1.4.14",
    )
    go_repository(
        name = "com_github_aws_aws_sdk_go_v2_config",
        importpath = "github.com/aws/aws-sdk-go-v2/config",
        sum = "h1:q2+/mqFhY0J9m3Tb5RGFE3R4sdaUkIe4k2EuDfE3c08=",
        version = "v1.20.0",
    )
    go_repository(
        name = "com_github_aws_aws_sdk_go_v2_credentials",
        importpath = "github.com/aws/aws-sdk-go-v2/credentials",
        sum = "h1:LQquqPE7cL55RQmA/UBoBKehDlEtMnQKm3B0Q672ePE=",
        version = "v1.14.0",
    )
    go_repository(
        name = "com_github_aws_aws_sdk_go_v2_feature_ec2_imds",
        importpath = "github.com/aws/aws-sdk-go-v2/feature/ec2/imds",
        sum = "h1:lF/cVllNAPKgjDwN2RsQUX9g/f6hXer9f10ubLFSoug=",
        version = "v1.14.0",
    )
    go_repository(
        name = "com_github_aws_aws_sdk_go_v2_feature_s3_manager",
        importpath = "github.com/aws/aws-sdk-go-v2/feature/s3/manager",
        sum = "h1:haAyxKHwoE+y/TJt+qHcPQf1dCViyyGbWcKjjYUllTE=",
        version = "v1.11.91",
    )
    go_repository(
        name = "com_github_aws_aws_sdk_go_v2_internal_configsources",
        importpath = "github.com/aws/aws-sdk-go-v2/internal/configsources",
        sum = "h1:tN6dNNE4SzMuyMnVtQJXGVKX177/d5Zy4MuA1HA4KUc=",
        version = "v1.2.0",
    )
    go_repository(
        name = "com_github_aws_aws_sdk_go_v2_internal_endpoints_v2",
        importpath = "github.com/aws/aws-sdk-go-v2/internal/endpoints/v2",
        sum = "h1:bfdsbTARDjaC/dSYGMO+E0psxFU4hTvCLnqYAfZ3D38=",
        version = "v2.5.0",
    )
    go_repository(
        name = "com_github_aws_aws_sdk_go_v2_internal_ini",
        importpath = "github.com/aws/aws-sdk-go-v2/internal/ini",
        sum = "h1:21tlTXq3ev10yLMAjXZzpkZbrl49h3ElSjmxD57tD/E=",
        version = "v1.4.0",
    )
    go_repository(
        name = "com_github_aws_aws_sdk_go_v2_internal_v4a",
        importpath = "github.com/aws/aws-sdk-go-v2/internal/v4a",
        sum = "h1:wmGLw2i8ZTlHLw7a9ULGfQbuccw8uIiNr6sol5bFzc8=",
        version = "v1.1.6",
    )
    go_repository(
        name = "com_github_aws_aws_sdk_go_v2_service_internal_accept_encoding",
        importpath = "github.com/aws/aws-sdk-go-v2/service/internal/accept-encoding",
        sum = "h1:7R8uRYyXzdD71KWVCL78lJZltah6VVznXBazvKjfH58=",
        version = "v1.9.15",
    )
    go_repository(
        name = "com_github_aws_aws_sdk_go_v2_service_internal_checksum",
        importpath = "github.com/aws/aws-sdk-go-v2/service/internal/checksum",
        sum = "h1:skaFGzv+3kA+v2BPKhuekeb1Hbb105+44r8ASC+q5SE=",
        version = "v1.1.38",
    )
    go_repository(
        name = "com_github_aws_aws_sdk_go_v2_service_internal_presigned_url",
        importpath = "github.com/aws/aws-sdk-go-v2/service/internal/presigned-url",
        sum = "h1:dJnwy5Awv+uvfk73aRENVbv1cSQQ60ydCkPaun097KM=",
        version = "v1.10.0",
    )
    go_repository(
        name = "com_github_aws_aws_sdk_go_v2_service_internal_s3shared",
        importpath = "github.com/aws/aws-sdk-go-v2/service/internal/s3shared",
        sum = "h1:9ulSU5ClouoPIYhDQdg9tpl83d5Yb91PXTKK+17q+ow=",
        version = "v1.15.6",
    )
    go_repository(
        name = "com_github_aws_aws_sdk_go_v2_service_s3",
        importpath = "github.com/aws/aws-sdk-go-v2/service/s3",
        sum = "h1:Ll5/YVCOzRB+gxPqs2uD0R7/MyATC0w85626glSKmp4=",
        version = "v1.40.2",
    )
    go_repository(
        name = "com_github_aws_aws_sdk_go_v2_service_sso",
        importpath = "github.com/aws/aws-sdk-go-v2/service/sso",
        sum = "h1:ZIlR6Wr/EgYwBdEz1NWBqdUsTh0mV7A68pId3YZl6H0=",
        version = "v1.16.0",
    )
    go_repository(
        name = "com_github_aws_aws_sdk_go_v2_service_ssooidc",
        importpath = "github.com/aws/aws-sdk-go-v2/service/ssooidc",
        sum = "h1:3BZyJei4k1SHdSAFhg9Qg15NnG3v5zosZyFWPm7df/A=",
        version = "v1.18.0",
    )
    go_repository(
        name = "com_github_aws_aws_sdk_go_v2_service_sts",
        importpath = "github.com/aws/aws-sdk-go-v2/service/sts",
        sum = "h1:f/V5Y9OaHuNRrA9MntNQNAtMFXqhKj8HTEPnH81eXMI=",
        version = "v1.24.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:/d/879q/Os9Zc5gyV3QVLfZoajN1KcWucf2zYCFeFxs=",
        version = "v1.47.6",
    )
    ...
    go_repository(
        ...
        sum = "h1:xnATPiybo6GgdRoC4YoGnxXZFRc3dqQTGi73oLvvBrE=",
        version = "v3.23.8",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:erH6cQjsaJrH+rJDU9qIf89KFdhK0Bft0aEZHlYC3Vs=",
        version = "v0.25.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:NqZC/WcesSn4O8L0I2JmuNsUigSyBQifVLYgM9LMQeQ=",
        version = "v1.20.0",
    )
    go_repository(
